...
class ProjectDetailsCtrl {
  ...
  updateInfo() {
    if (this.oldName === this.projectDetails.name && this.oldDescription === this.projectDetails.description) {
      this.codenvyNotificationService.showError('Impossible to rename the project. The name \'' + this.oldName + '\' is already used.');
      return;
    }
